...
export default function StorySection({ className = "" }: StorySectionProps) {
  ...
  const scrollToNext = () => {
    const nextSection = document.getElementById("detail");
    if (nextSection) {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="absolute left-[6vw] bottom-[14vh] max-w-[38vw] z-20"
      >
        <h2
        ...
        >
          From sketch to finish—crafted to wear forever.
        </p>
        <button className="cta-gold">Meet the maker</button>
      </div>
