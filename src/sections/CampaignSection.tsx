...
export default function CampaignSection({
  ...
  const scrollToNext = () => {
    const nextSection = document.getElementById("essence");
    if (nextSection) {
  ...
  return (
    ...
    >
      ...
      {/* Headline Block - Right Aligned */}
      <div
        ref={headlineBlockRef}
        className="absolute right-[6vw] top-1/2 -translate-y-1/2 text-right max-w-[34vw] z-20"
      >
        <h2
        ...
        >
          This season: softer lines, bolder presence.
        </p>
        <button className="cta-gold">Read the story</button>
      </div>
