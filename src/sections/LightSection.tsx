...
export default function LightSection({ className = "" }: LightSectionProps) {
  ...
  const scrollToNext = () => {
    const nextSection = document.getElementById("silhouette");
    if (nextSection) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-20 pointer-events-none">
        ...
        >
          Polished surfaces that catch the day.
        </p>
